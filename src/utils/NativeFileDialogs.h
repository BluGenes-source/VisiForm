...
[[nodiscard]] std::optional<std::filesystem::path> showOpenLookAndFeelPresetDialog(const std::filesystem::path& initialDirectory = {});
[[nodiscard]] std::optional<std::filesystem::path> showSaveLookAndFeelPresetDialog(
    const std::filesystem::path& suggestedPath,
    const std::filesystem::path& initialDirectory = {});
