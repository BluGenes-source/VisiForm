...
const std::vector<CommandDefinition> kDefinitions = {
    ...
    { ids::kLayoutAlignLeft, "Align Left", "Layout", "Ctrl+Alt+Left", "Align to the primary widget's left edge" },
    { ids::kLayoutAlignTop, "Align Top", "Layout", "Ctrl+Alt+Up", "Align to the primary widget's top edge" },
    { ids::kLayoutAlignRight, "Align Right", "Layout", "Ctrl+Alt+Right", "Align to the primary widget's right edge" },
    { ids::kLayoutAlignBottom, "Align Bottom", "Layout", "Ctrl+Alt+Down", "Align to the primary widget's bottom edge" },
    { ids::kLayoutCenterHorizontal, "Center Horizontally", "Layout", "", "Align horizontal centers to the primary widget" },
    { ids::kLayoutCenterVertical, "Center Vertically", "Layout", "", "Align vertical centers to the primary widget" },
    { ids::kLayoutSameWidth, "Same Width", "Layout", "", "Match widths to the primary widget" },
    { ids::kLayoutSameHeight, "Same Height", "Layout", "", "Match heights to the primary widget" },
